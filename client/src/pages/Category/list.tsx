...
const TicketList = () => {
    ...
    const GetCategory = async () => {
                try {
                    ...
                    setItems(response.CategoryList);
                    setInitialRecords(response.CategoryList);
            ...
            useEffect(() => {
                dispatch(setPageTitle('Category List'));
                GetCategory();
            },[]);   
                ...
                if (id) {
                    try {
                        ...
                        if (response.response =='Success' ) {
                            GetCategory();
                            showToast('Category Deleted Successfullly','success'); 
                        }
                    } catch (error) {
                        return ('Something Went Wrong');
                    }
            ...
            <div className="invoice-table">
                <div className="mb-4.5 px-5 w-full flex md:items-center md:flex-row flex-col gap-5">
                    <div className="flex  items-center w-72 gap-2">
                        ...
                        <Link to="/category/add" className="btn btn-primary  gap-2">
                    ...
                    <h3 className="flex text-xl w-full font-semibold justify-center">Category List</h3>
                        ...
                        columns={[
                            {
                                ...
                                render: ({ category_id }) => (
                                    <div className="flex gap-4 items-center w-max mx-auto">
                                        <NavLink to={`/category/edit/${ category_id }`} className="flex hover:text-info">
                                        ...
                                        <button type="button" className="flex hover:text-danger" onClick={(e) => deleteRow(category_id)}>
